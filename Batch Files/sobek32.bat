...
aspnet_compiler -v /SobekCM C:\Staging32
echo DELETING UNNECESSARY FILES
del c:\staging32\error.html
del c:\staging32\oai2.xsl
del c:\staging32\sobekcm.sln
del c:\staging32\web.config
del c:\staging32\SobekCM.sln.docstates.suo
del c:\staging32\SobekCM.suo
echo.
