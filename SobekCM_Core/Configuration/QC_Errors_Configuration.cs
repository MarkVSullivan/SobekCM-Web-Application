...
//{
//    /// <summary> Class keeps all the system-wide quality control error profiles which 
//    /// can be used within the system  </summary>


//    public  static class QC_Errors_Configuration
//    {
//        private static bool attemptedRead;
//        private static Dictionary<string, QualityControl_ErrorProfile> profiles;
//        private static QualityControl_ErrorProfile defaultProfile;
...
//         static QC_Errors_Configuration()
//        {
//            // Declare all the new collections in this configuration 
//            profiles = new Dictionary<string, QualityControl_ErrorProfile>();
...
//            sobekcm_qc_configfilePath=(baseDirectory + "config\\sobekcm_qc_errors.config");
...
//        /// <summary> Clears the error profiles from the current </summary>
...
//        public static void Add_Profile(QualityControl_ErrorProfile New_Profile)
//        {
...
//        public static QualityControl_ErrorProfile Default_Profile
//        {
//            get
//            {
...
//            QualityControl_ErrorProfile newProfile = new QualityControl_ErrorProfile();
...
//                foreach (QualityControl_ErrorProfile profile in profiles.Values)
//                {
...
//                    foreach (QualityControl_Error_Config thisConfig in profile.All_Division_Types)
//                    {
...
//                        {
//                            case "profiles":
//                                read_qc_error_profiles(readerXml.ReadSubtree());
//                                break;
//                        }
//                    }
//                }
...
//        private static void read_qc_error_profiles(XmlReader readerXml)
//        {
//            bool inPackage = false;
//            bool inDivision = false;
//            bool inFile = false;
//            bool inDmdSec = true;
//            QualityControl_ErrorProfile profile = null;
...
//                    {
//                        case "profile":
//                            profile = new QualityControl_ErrorProfile();
...
//        private List<QualityControl_Error_Config> divisionTypes;

//        private Dictionary<string, QualityControl_Error_Config> divisionTypeLookup;

//        /// <summary> Constructor for a new instance of the QualityControl_Profile class </summary>
//        public QualityControl_ErrorProfile()
//        {
//            divisionTypes = new List<QualityControl_Error_Config>();
//            divisionTypeLookup = new Dictionary<string, QualityControl_Error_Config>();
...
//        public QualityControl_ErrorProfile( string Profile_Name, string Profile_Description, bool Default_Profile )
//        {
//            divisionTypes = new List<QualityControl_Error_Config>();
//            divisionTypeLookup = new Dictionary<string, QualityControl_Error_Config>();
...
//        public ReadOnlyCollection<QualityControl_Error_Config> All_Division_Types
//        {
//            get { return new ReadOnlyCollection<QualityControl_Error_Config>(divisionTypes); }
//        }

//        /// <summary> Add a new division type to this profile </summary>
//        /// <param name="Division_Config"> New division type to add </param>
//        public void Add_Division_Type(QualityControl_Error_Config Division_Config )
//        {
...
//        public void Remove_Division_Type( QualityControl_Error_Config Division_Config )
//        {
...
//        public QualityControl_Error_Config  this[string TypeName]
//        {
//            get
//            {
...
//#region QualityControl_Error_Category_Config class
//    public class QualityControl_Error_Category_Config
//    {
//        internal int ID { get; set; }

//        public string TypeName { get; internal set; }

//        public List<QualityControl_Error_Config> 
//    }
//#endregion
...
//    #region QualityControl_Error_Config class 
 
//    /// <summary> Configuration information for a single possible division type </summary>
//    public class QualityControl_Error_Config  
//    {
...
//        /// <summary> Name of this error type, which the user selects.  This is also the default name, if
//        /// a translation for this name is not provided in a requested language </summary>
//        public string TypeName { get; internal set;  }

//        /// <summary> Flag indicates if this error type is one not defined in this list. The user can specify details of this error </summary>
//        public bool isOther { get; internal set; }

//        /// <summary> Flag indicates if this is a volume error </summary>
//        public bool isVolumeError { get; internal set; }
...
//        public QualityControl_Error_Config()
//        {
...
//        /// <summary> Constructor for a new instance of the QualityControl_Error_Config class </summary>
//        /// <param name="ID"> Key for this QC error configuration information </param>
...
//        public QualityControl_Error_Config(int ID, string errorCode, string TypeName, bool isOther, string description)
//        {
//            typeTranslations = new Dictionary<Web_Language_Enum, string>();
//            this.ID = ID;
...
//        /// <param name="TypeName"> Name of this type, which the user selects.  This is also the default name, if
//        /// a translation for this name is not provided in a requested language </param>
//        public QualityControl_Error_Config(int ID, string errorCode, string TypeName )
//        {
//            typeTranslations = new Dictionary<Web_Language_Enum, string>();
//            this.ID = ID;
//            this.TypeName = TypeName;
...
//        /// <param name="isVolumeError"></param>
//        public QualityControl_Error_Config(int ID, string errorCode, string TypeName, bool isVolumeError)
//        {
//            this.ID = ID;
//            this.ErrorCode = errorCode;
//            this.TypeName = TypeName;
//            this.isVolumeError = isVolumeError;
//            this.isOther = false;
//            this.Description = String.Empty;
//        }

//        /// <summary> Flag indicates if this error config has translations </summary>
