    ...
    public class Edit_Group_Behaviors_MySobekViewer : abstract_MySobekViewer
    {
       ...
       /// <summary> Title for the page that displays this viewer, this is shown in the search box at the top of the page, just below the banner </summary>
        ...
        public override void Add_HTML_In_Main_Form(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            Output.WriteLine("  <b>Edit the behaviors associated with this item group within this library.</b>");
            Output.WriteLine("    <ul>");
       ...
       {
           Tracer.Add_Trace("Edit_Group_Behaviors_MySobekViewer.Add_Controls", "Do nothing");
       }
