...
namespace SobekCM.Resource_Object.METS_Sec_ReaderWriters
{
    ...
    /// by the METS  reader to write the main administrative section for a digital resource </summary>
    public interface iPackage_amdSec_ReaderWriter
    {
        ...
        bool Write_amdSec(TextWriter Output_Stream, SobekCM_Item METS_Item, Dictionary<string, object> Options);
        ...
        /// <returns> TRUE if successful, otherwise FALSE</returns>
        bool Read_amdSec(XmlReader Input_XmlReader, SobekCM_Item Return_Package, Dictionary<string, object> Options);
        ...
        bool Include_amdSec(SobekCM_Item METS_Item, Dictionary<string, object> Options);
