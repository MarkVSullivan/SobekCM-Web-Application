...
namespace SobekCM_Stats_Reader
{
    public partial class SobekCM_Database_Selection_Form : Form
    {
        ...
        private void testConnectionButton_Button_Pressed(object sender, EventArgs e)
        {
            ...
            if (SobekCM.Library.Database.SobekCM_Database.Test_Connection(Connection_String))
        ...
        private void saveButton_Button_Pressed(object sender, EventArgs e)
        {
            ...
            if ((during_install) || (SobekCM.Library.Database.SobekCM_Database.Test_Connection(Connection_String)))
            {
