...
namespace SobekCM.Library.AdminViewer
{
    ...
    /// </ul></remarks>
    class Settings_AdminViewer_Legacy : abstract_AdminViewer
    {
        ...
        public Settings_AdminViewer_Legacy(RequestCache RequestSpecificValues) : base(RequestSpecificValues)
        {
        ...
        private void build_setting_objects_for_display()
        {
            ...
            if (!limitedRightsMode)
            {
                string[] files = Directory.GetFiles(UI_ApplicationCache_Gateway.Settings.Servers.Base_Directory + "\\config\\default", "sobekcm_static_resources_*.config");
