...
namespace SobekCM.Library.AdminViewer
{
    ...
    class Settings_AdminViewer : abstract_AdminViewer
    {
        ...
        public Settings_AdminViewer(RequestCache RequestSpecificValues) : base(RequestSpecificValues)
        {
			...
			Add_Setting_UI("Shibboleth User Identity Attribute", "Authentication", 200, empty_options, "The name of the attribute from Shibboleth which holds the RequestSpecificValues.Current_User identity information, for RequestSpecificValues.Current_User identification.\n\nSpeak to your Shibboleth administrator for this information.", false);
