...
namespace SobekCM.Library.AdminViewer
{
    ...
    class Settings_AdminViewer : abstract_AdminViewer
    {
        ...
        public Settings_AdminViewer(User_Object User, SobekCM_Navigation_Object Current_Mode, Custom_Tracer Tracer) : base(User)
        {
			...
			Add_Setting_UI("JPEG2000 Server Type", "Server Configuration", -1, new[] { "Aware", "None"}, "Type of the JPEG2000 server found at the URL above.", false);
        ...
        public override void Add_HTML_In_Main_Form(TextWriter Output, Custom_Tracer Tracer)
        {
			...
			Output.WriteLine("<script src=\"" + currentMode.Base_URL + "default/scripts/sobekcm_tabs.js\" type=\"text/javascript\"></script>");
			Output.WriteLine();
