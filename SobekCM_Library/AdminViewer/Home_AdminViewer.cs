...
namespace SobekCM.Library.AdminViewer
{
    ...
    public class Home_AdminViewer : abstract_AdminViewer
    {
        ...
        public override void Write_HTML(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            Output.WriteLine(" &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; For clarification on any of these options, <a href=\"" + SobekCM_Library_Settings.Help_URL(currentMode.Base_URL) + "adminhelp/tasks\" target=\"ADMIN_USER_HELP\" >click here to view the help page</a>.<br /><br />");
