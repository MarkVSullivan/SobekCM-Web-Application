    ...
    public static class MainMenus_Helper_HtmlSubWriter
    {
        ...
        public static void Add_Aggregation_Search_Results_Menu(TextWriter Output, RequestCache RequestSpecificValues, bool Include_Bookshelf_View )
        {
            ...
            if (Include_Bookshelf_View)
            {
                ...
                {
                    Output.WriteLine("    <li id=\"selected-sf-menu-item-link\"><a href=\"\">" + bookshelf_view + "</a></li>");
                }
                else
                {
            ...
            if ((RequestSpecificValues.Current_Mode.Coordinates.Length > 0) || (RequestSpecificValues.Hierarchy_Object.Result_Views.Contains(Result_Display_Type_Enum.Map)))
            {
                ...
                {
                    Output.WriteLine("    <li id=\"selected-sf-menu-item-link\"><a href=\"\">" + map_view + "</a></li>");
                }
                else
                {
            ...
            if (RequestSpecificValues.Hierarchy_Object.Result_Views.Contains(Result_Display_Type_Enum.Brief))
            {
                ...
                {
                    Output.WriteLine("    <li id=\"selected-sf-menu-item-link\"><a href=\"\">" + brief_view + "</a></li>");
                }
                else
                {
            ...
            if (RequestSpecificValues.Hierarchy_Object.Result_Views.Contains(Result_Display_Type_Enum.Table))
            {
                ...
                {
                    Output.WriteLine("    <li id=\"selected-sf-menu-item-link\"><a href=\"\">" + table_view + "</a></li>");
                }
                else
                {
            ...
            if (RequestSpecificValues.Hierarchy_Object.Result_Views.Contains(Result_Display_Type_Enum.Thumbnails))
            {
                ...
                {
                    Output.WriteLine("    <li id=\"selected-sf-menu-item-link\"><a href=\"\">" + thumbnail_view + "</a></li>");
                }
                else
                {
        ...
        public static void Add_UserSpecific_Main_Menu(TextWriter Output, RequestCache RequestSpecificValues )
        {
            ...
            if (RequestSpecificValues.Current_User != null)
            {
                ...
                if ((RequestSpecificValues.Current_User.Is_System_Admin) || (RequestSpecificValues.Current_User.Is_Portal_Admin))
                {
                    ...
                    Output.WriteLine("        <li id=\"sbkUsm_AdminAggrWizard\"><a href=\"" + UrlWriterHelper.Redirect_URL(RequestSpecificValues.Current_Mode) + "\"><img src=\"" + RequestSpecificValues.Current_Mode.Default_Images_URL + "wizard.png\" /> <div class=\"sbkUsm_TextWithImage\">Add Collection Wizard</div></a></li>");
                    ...
                    Output.WriteLine("        <li id=\"sbkUsm_AdminCurrSkin\"><a href=\"" + UrlWriterHelper.Redirect_URL(RequestSpecificValues.Current_Mode) + "\"><img src=\"" + RequestSpecificValues.Current_Mode.Default_Images_URL + "skins.png\" /> <div class=\"sbkUsm_TextWithImage\">Edit Current Web Skin</div></a></li>");
                    RequestSpecificValues.Current_Mode.My_Sobek_SubMode = String.Empty;
                    ...
                    Output.WriteLine("        <li id=\"sbkUsm_AdminUserReport\"><a href=\"" + UrlWriterHelper.Redirect_URL(RequestSpecificValues.Current_Mode) + "\"><img src=\"" + RequestSpecificValues.Current_Mode.Default_Images_URL + "icon_permission.png\" /> <div class=\"sbkUsm_TextWithImage\">User Permissions Reports</div></a></li>");
