...
namespace SobekCM.Library.AggregationViewer.Viewers
{
    ...
    public class Advanced_Search_AggregationViewer : abstractAggregationViewer
    {
        ...
        public override void Add_Search_Box_HTML(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            const string containsMeaning = "Contains the search term or terms of similar meaning";
        ...
        private void add_drop_down_options(TextWriter Output, string drop_value )
        {
            ...
            {
                if (searchField.Web_Code == drop_value)
                {
