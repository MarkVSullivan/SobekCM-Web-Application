...
namespace SobekCM.Library.Citation.Elements
{
    ...
    public class Tickler_Element : multipleTextBox_Element
    {
        ...
        public override void Render_Template_HTML(TextWriter Output, SobekCM_Item Bib, string Skin_Code, bool isMozilla, StringBuilder popup_form_builder, User_Object Current_User, Language_Enum CurrentLanguage, Language_Support_Info Translator, string Base_URL )
        {
            ...
            render_helper(Output, Bib.SobekCM_Web.Ticklers, Skin_Code, Current_User, CurrentLanguage, Translator, Base_URL);
        }
        ...
        {
            Bib.SobekCM_Web.Clear_Ticklers();
        }
        ...
        public override void Save_To_Bib(SobekCM_Item Bib)
        {
            ...
            {
                Bib.SobekCM_Web.Add_Tickler(HttpContext.Current.Request.Form[thisKey]);
            }
        }
    }
}
