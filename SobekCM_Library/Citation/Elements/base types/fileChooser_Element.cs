...
namespace DLC.MetaTemplate.Elements
{
    ...
    /// </summary>
    public abstract class fileChooser_Element : abstract_Element
    {
        ...
        public fileChooser_Element( int lines )
        {
            this.lines = lines;
        ...
        public fileChooser_Element(int lines, string defaultTitle)
        {
            this.lines = lines;
        ...
        void fileList_Click(object sender, EventArgs e)
        {
            ...
            MetaTemplate.Forms.Select_Files_Form select = new MetaTemplate.Forms.Select_Files_Form(possibleFiles, includedFiles, show_filter_options, xp_theme);
        ...
        protected override void Inner_Set_Read_Only()
        {
            if (read_only)
            {
                fileList.BackColor = Color.WhiteSmoke;
            }
            else
            {
                fileList.BackColor = Color.White;
        ...
        {
            // Get the new element
            fileChooser_Element newElement = (fileChooser_Element)Element_Factory.getElement(this.Type, this.Display_SubType);
