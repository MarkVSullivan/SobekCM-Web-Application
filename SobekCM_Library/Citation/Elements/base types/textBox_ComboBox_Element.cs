...
namespace SobekCM.Library.Citation.Elements
{
    ...
    public abstract class textBox_ComboBox_Element : abstract_Element
    {
        ...
        protected void render_helper(TextWriter Output, List<string> text_values, List<string> select_values, string Skin_Code, User_Object Current_User, Language_Enum CurrentLanguage, Language_Support_Info Translator, string Base_URL )
        {
