namespace SobekCM.Library.Localization.Classes
{
    ...
    public class New_Group_And_Item_MySobekViewer_LocalizationInfo : baseLocalizationInfo
    {
        ...
        public override void Add_Localization_String(string Key, string Value)
        {
            ...
            switch (Key)
            {
                ...
                case "Upload The Related Files For Your New Item You Can Also Provide Labels For Each File Once They Are Uploaded":
                    UploadTheRelatedFilesForYourNewItemYouCan = Value;
                    break;
                ...
                case "Upload The Related Files Or Enter A URL For Your New Item You Can Also Provide Labels For Each File Once They Are Uploaded":
                    UploadTheRelatedFilesOrEnterAURLForYourN = Value;
                    break;
                ...
                case "You Must Read And Accept The Below Permissions To Continue":
                    YouMustReadAndAcceptTheBelowPermissionsTo = Value;
                    break;

                case "You Must Read And Accept The Above Permissions Agreement To Continue":
                    YouMustReadAndAcceptTheAbovePermissionsAgr = Value;
                    break;
                ...
                case "You May Also Change Your Current XXX For This Submission":
                    YouMayAlsoChangeYourCurrentXXXForThisSubm = Value;
                    break;
                ...
                case "Enter The Basic Information To Describe Your New Item":
                    EnterTheBasicInformationToDescribeYourNewI = Value;
                    break;
                ...
                case "Your Item Has Been Successfully Added To The Digital Library And Will Appear Immediately":
                    YourItemHasBeenSuccessfullyAddedToTheDigit = Value;
                    break;
                ...
                case "Search Indexes May Take A Couple Minutes To Build At Which Time This Item Will Be Discoverable Through The Search Interface":
                    SearchIndexesMayTakeACoupleMinutesToBuild = Value;
                    break;

                case "An Email Has Been Sent To You With The New Item Information":
                    AnEmailHasBeenSentToYouWithTheNewItemIn = Value;
                    break;
                ...
                case "An Email Has Been Sent To The Programmer Who Will Attempt To Correct Your Issue You Should Be Contacted Within The Next 2448 Hours Regarding This Issue":
                    AnEmailHasBeenSentToTheProgrammerWhoWill = Value;
                    break;
        ...
        public string UploadTheRelatedFilesForYourNewItemYouCan { get; private set; }
        ...
        public string UploadTheRelatedFilesOrEnterAURLForYourN { get; private set; }
        ...
        public string YouMustReadAndAcceptTheBelowPermissionsTo { get; private set; }

        /// <remarks> 'You must read and accept the above permissions agreement to continue.' localization string </remarks>
        public string YouMustReadAndAcceptTheAbovePermissionsAgr { get; private set; }
        ...
        public string YouMayAlsoChangeYourCurrentXXXForThisSubm { get; private set; }
        ...
        public string EnterTheBasicInformationToDescribeYourNewI { get; private set; }
        ...
        public string YourItemHasBeenSuccessfullyAddedToTheDigit { get; private set; }
        ...
        public string SearchIndexesMayTakeACoupleMinutesToBuild { get; private set; }

        /// <remarks> 'An email has been sent to you with the new item information.' localization string </remarks>
        public string AnEmailHasBeenSentToYouWithTheNewItemIn { get; private set; }
        ...
        public string AnEmailHasBeenSentToTheProgrammerWhoWill { get; private set; }
