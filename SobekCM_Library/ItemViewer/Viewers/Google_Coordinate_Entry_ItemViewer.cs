...
namespace SobekCM.Library.ItemViewer.Viewers
{
    ...
    public class Google_Coordinate_Entry_ItemViewer : abstractItemViewer
    {
        ...
        public override void Add_Main_Viewer_Section(PlaceHolder placeHolder, Custom_Tracer Tracer)
        {
            ...
            mapperBuilder.AppendLine("                 </div> ");
            mapperBuilder.AppendLine("                 <div class=\"toolbar_grouping\"> ");
            mapperBuilder.AppendLine("                     <input id=\"content_toolbar_searchField\" class=\"search\" type=\"text\" placeholder=\"Locate\" onBlur=\"finder(this.value);\" onClick=\"this.select();\" /> ");
            mapperBuilder.AppendLine("                     <div id=\"content_toolbar_searchButton\"></div> ");
            mapperBuilder.AppendLine("                 </div> ");
            mapperBuilder.AppendLine("             </div> ");
            mapperBuilder.AppendLine("         </div> ");
            mapperBuilder.AppendLine("  ");
            mapperBuilder.AppendLine("     <div id=\"container_toolbarGrabber\"> ");
            mapperBuilder.AppendLine("         <div id=\"content_toolbarGrabber\"></div> ");
            mapperBuilder.AppendLine("     </div>     ");
            mapperBuilder.AppendLine("  ");
            mapperBuilder.AppendLine("     <div id=\"container_pane_2\"> ");
            mapperBuilder.AppendLine("          ");
            mapperBuilder.AppendLine("         <div id=\"container_message\"> ");
            mapperBuilder.AppendLine("             <div id=\"content_message\"></div> ");
            mapperBuilder.AppendLine("         </div> ");
            mapperBuilder.AppendLine("          ");
            mapperBuilder.AppendLine("         <div id=\"container_toolbox\" class=\"ui-widget-content\"> ");
            mapperBuilder.AppendLine("             <div id=\"container_toolboxMinibar\"> ");
            ...
            mapperBuilder.AppendLine("             </div> ");
            mapperBuilder.AppendLine("             <div id=\"container_toolboxTabs\"> ");
            ...
            mapperBuilder.AppendLine("                         <div id=\"container_toolbox_tab1\"> ");
            mapperBuilder.AppendLine("                             <div id=\"container_grid\"> ");
            mapperBuilder.AppendLine("                              ");
            ...
            mapperBuilder.AppendLine("                 <div class=\"tab\"> ");
            mapperBuilder.AppendLine("                     <div class=\"toolbox_tab-content\"> ");
            mapperBuilder.AppendLine("                         <div id=\"container_toolbox_tab2\"> ");
            mapperBuilder.AppendLine("                             <img id=\"content_toolbox_button_manageItem\" /> ");
            mapperBuilder.AppendLine("                             <img id=\"content_toolbox_button_manageOverlay\" /> ");
            mapperBuilder.AppendLine("                             <img id=\"content_toolbox_button_managePOI\" /> ");
            mapperBuilder.AppendLine("                             <div class=\"lineBreak\"></div> ");
            mapperBuilder.AppendLine("                             <input id=\"content_toolbox_searchField\" class=\"search\" type=\"text\" placeholder=\"Locate\" onBlur=\"finder(this.value);\" onClick=\"this.select();\" /> ");
            mapperBuilder.AppendLine("                             <div id=\"content_toolbox_searchButton\"></div> ");
            mapperBuilder.AppendLine("                             <div class=\"lineBreak\"></div> ");
            ...
            mapperBuilder.AppendLine("                 <div class=\"tab\"> ");
            mapperBuilder.AppendLine("                     <div class=\"toolbox_tab-content\"> ");
            mapperBuilder.AppendLine("                         <div id=\"container_toolbox_tab3\"> ");
            mapperBuilder.AppendLine("                             <img id=\"content_toolbox_button_placeItem\"/> ");
            mapperBuilder.AppendLine("                             <img id=\"content_toolbox_button_itemGetUserLocation\"/>     ");
            mapperBuilder.AppendLine("                             <div class=\"lineBreak\"></div> ");
            ...
            mapperBuilder.AppendLine("                             <div class=\"lineBreak\"></div> ");
            mapperBuilder.AppendLine("                             <div class=\"centerRow\"> ");
            ...
            mapperBuilder.AppendLine("                 <div class=\"tab\"> ");
            mapperBuilder.AppendLine("                     <div class=\"toolbox_tab-content\"> ");
            mapperBuilder.AppendLine("                         <img id=\"content_toolbox_button_placeOverlay\" class=\"button\"/> ");
            mapperBuilder.AppendLine("                         <img id=\"content_toolbox_button_overlayGetUserLocation\" class=\"button\"/> ");
            ...
            mapperBuilder.AppendLine("                             </div> ");
            mapperBuilder.AppendLine("                             <div id=\"content_toolbox_rotationCounterClockwise\"></div> ");
            mapperBuilder.AppendLine("                             <div id=\"content_toolbox_rotationReset\"></div> ");
            mapperBuilder.AppendLine("                             <div id=\"content_toolbox_rotationClockwise\"></div> ");
            mapperBuilder.AppendLine("                         </div> ");
            ...
            //new custom js here
            mapperBuilder.AppendLine("<script type=\"text/javascript\" src=\"" + CurrentMode.Base_URL + "default/scripts/sobekcm_mapper_content.js\"></script>"); //custom script
            mapperBuilder.AppendLine("<script type=\"text/javascript\" src=\"" + CurrentMode.Base_URL + "default/scripts/sobekcm_mapper_listener_actions.js\"></script>"); //custom script
            mapperBuilder.AppendLine("<script type=\"text/javascript\" src=\"" + CurrentMode.Base_URL + "default/scripts/sobekcm_mapper_listeners.js\"></script>"); //custom script
            ...
            //mapperBuilder.AppendLine(" 	                    <a href=\"./mapedit\" id=\"toolbar_reset\" title=\"Reset: Reset Map To Defaults\"><img class=\"button\" src=\"/default/images/mapper/button-reset.png\" /></a> ");
            //mapperBuilder.AppendLine(" 	                    <a href=\"#\" id=\"toolbar_toggleControls\" title=\"Controls: Toggle Map Controls\"><img class=\"button\" src=\"/default/images/mapper/button-controls.png\" /></a> ");
            //mapperBuilder.AppendLine("                         <a href=\"#\" id=\"toolbar_toggletoolbox\" title=\"Toolbox: Toggle Toolbox\" onclick=\"toggletoolbox(4);\"><img class=\"button\" src=\"/default/images/mapper/button-toolbox.png\" /></a> ");
            //mapperBuilder.AppendLine("                     </div> ");
            //mapperBuilder.AppendLine("                     <div class=\"grouping\"> ");
            //mapperBuilder.AppendLine(" 	                    <a href=\"#\" id=\"toolbar_layerRoadmap\" title=\"Roadmap: Toggle Road Map Layer\"><img class=\"button\" src=\"/default/images/mapper/button-roadmap.png\" /></a> ");
            //mapperBuilder.AppendLine(" 	                    <a href=\"#\" id=\"toolbar_layerTerrain\" title=\"Terrain: Toggle Terrain Map Layer\"><img class=\"button\" src=\"/default/images/mapper/button-terrain.png\" /></a> ");
            //mapperBuilder.AppendLine(" 	                    <a href=\"#\" id=\"toolbar_layerSatellite\" title=\"Satellite: Toggle Satellite Map Layer\"><img class=\"button\" src=\"/default/images/mapper/button-satellite.png\" /></a> ");
            //mapperBuilder.AppendLine(" 	                    <a href=\"#\" id=\"toolbar_layerHybrid\" title=\"Hybrid: Toggle Hybrid Map Layer\"><img class=\"button\" src=\"/default/images/mapper/button-hybrid.png\" /></a> ");
            //mapperBuilder.AppendLine(" 	                    <a href=\"#\" id=\"toolbar_layerCustom\" title=\"Block/Lot: Toggle Block/Lot Map Layer\"><img class=\"button\" src=\"/default/images/mapper/button-blockLot.png\" /></a> ");
            //mapperBuilder.AppendLine("                         <a href=\"#\" id=\"toolbar_layerReset\" title=\"Reset Map Type\"><img class=\"button\" src=\"/default/images/mapper/button-layerReset.png\" /></a> ");
            //mapperBuilder.AppendLine(" 	                </div> ");
            //mapperBuilder.AppendLine("                     <div class=\"grouping\"> ");
            //mapperBuilder.AppendLine(" 	                    <a href=\"#\" id=\"toolbar_panUp\" title=\"Pan Map Up\"><img class=\"button\" src=\"/default/images/mapper/button-panUp.png\" /></a> ");
            //mapperBuilder.AppendLine(" 	                    <a href=\"#\" id=\"toolbar_panLeft\" title=\"Pan Map Left\"><img class=\"button\" src=\"/default/images/mapper/button-panLeft.png\" /></a> ");
            //mapperBuilder.AppendLine("                         <a href=\"#\" id=\"toolbar_panReset\" title=\"Pan To Default\"><img class=\"button\" src=\"/default/images/mapper/button-panReset.png\" /></a> ");
            //mapperBuilder.AppendLine(" 	                    <a href=\"#\" id=\"toolbar_panRight\" title=\"Pan Map Right\"><img class=\"button\" src=\"/default/images/mapper/button-panRight.png\" /></a> ");
            //mapperBuilder.AppendLine(" 	                    <a href=\"#\" id=\"toolbar_panDown\" title=\"Pan Map Down\"><img class=\"button\" src=\"/default/images/mapper/button-panDown.png\" /></a> ");
            //mapperBuilder.AppendLine("                     </div> ");
            //mapperBuilder.AppendLine("                     <div class=\"grouping\"> ");
            //mapperBuilder.AppendLine(" 	                    <a href=\"#\" id=\"toolbar_zoomIn\" title=\"Zoom Map In\" onclick=\"checkZoomLevel();\"><img class=\"button\" src=\"/default/images/mapper/button-zoomIn.png\" /></a> ");
            //mapperBuilder.AppendLine(" 	                    <a href=\"#\" id=\"toolbar_zoomReset\" title=\"Reset Zoom Levels\"><img class=\"button\" src=\"/default/images/mapper/button-zoomReset2.png\" /></a> ");
            //mapperBuilder.AppendLine("                         <a href=\"#\" id=\"toolbar_zoomOut\" title=\"Zoom Map Out\" onclick=\"checkZoomLevel();\"><img class=\"button\" src=\"/default/images/mapper/button-zoomOut.png\" /></a> ");
            //mapperBuilder.AppendLine("                     </div> ");
            //mapperBuilder.AppendLine("                     <div class=\"grouping\"> ");
            //mapperBuilder.AppendLine("                         <a href=\"#\" id=\"toolbar_manageItem\" title=\"Manage Location Details\" onclick=\"action1();\"><img class=\"button\" src=\"/default/images/mapper/button-action1.png\" /></a> ");
            //mapperBuilder.AppendLine("                         <a href=\"#\" id=\"toolbar_manageOverlay\" title=\"Manage Map Coverage\" onclick=\"action2();\"><img class=\"button\" src=\"/default/images/mapper/button-action2.png\" /></a> ");
            //mapperBuilder.AppendLine("                         <a href=\"#\" id=\"toolbar_managePOI\" title=\"Manage Point of Interest\" onclick=\"action3();\"><img class=\"button\" src=\"/default/images/mapper/button-action3.png\" /></a> ");
            //mapperBuilder.AppendLine("                     </div> ");
            //mapperBuilder.AppendLine("                     <div class=\"grouping\"> ");
            ...
            //mapperBuilder.AppendLine("         </div> ");
            //mapperBuilder.AppendLine("  ");
            //mapperBuilder.AppendLine("         <div id=\"container_toggle_toolbar1\"><a href=\"#\" id=\"toolbar_toggle1\" title=\"Toolbar: Hide the Toolbar\" onclick=\"Toggle('#container2a');\"><img src=\"/default/images/mapper/toolbar-toggle.png\" /></a></div> ");
            //mapperBuilder.AppendLine("         <div id=\"container_toggle_toolbar2\"><a href=\"#\" id=\"toolbar_toggle2\" title=\"Toolbar: Show the Toolbar\" onclick=\"Toggle('#container2a');\"><img src=\"/default/images/mapper/toolbar-toggle.png\" /></a></div> ");
            //mapperBuilder.AppendLine("          ");
            ...
            //mapperBuilder.AppendLine("                      ");
            //mapperBuilder.AppendLine("                     <a href=\"#\" id=\"tmin\" onclick=\"toggletoolbox(1);\"><img src=\"/default/images/mapper/toolbox-minimize2.png\" /></a> ");
            //mapperBuilder.AppendLine("                     <a href=\"#\" id=\"tmax\" onclick=\"toggletoolbox(2);\"><img src=\"/default/images/mapper/toolbox-maximize2.png\" /></a> ");
            //mapperBuilder.AppendLine("                     <a href=\"#\" id=\"tclose\" onclick=\"toggletoolbox(3);\"><img src=\"/default/images/mapper/toolbox-close2.png\" /></a> ");
            //mapperBuilder.AppendLine("                 </div> ");
            ...
            //mapperBuilder.AppendLine("                                 <td><a id=\"toolbox_layerRoadmap\" title=\"Roadmap: Toggle Road Map Layer\"><img class=\"button\" src=\"/default/images/mapper/button-roadmap.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_layerTerrain\" title=\"Terrain: Toggle Terrain Map Layer\"><img class=\"button\" src=\"/default/images/mapper/button-terrain.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td>&nbsp;</td> ");
            //mapperBuilder.AppendLine("                                 <td></td> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_panUp\" title=\"Pan Map Up\"><img class=\"button\" src=\"/default/images/mapper/button-panUp.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td></td> ");
            //mapperBuilder.AppendLine("                             </tr> ");
            //mapperBuilder.AppendLine("                             <tr> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_layerSatellite\" title=\"Satellite: Toggle Satellite Map Layer\"><img class=\"button\" src=\"/default/images/mapper/button-satellite.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_layerHybrid\" title=\"Hybrid: Toggle Hybrid Map Layer\"><img class=\"button\" src=\"/default/images/mapper/button-hybrid.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td>&nbsp;</td> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_panLeft\" title=\"Pan Map Left\"><img class=\"button\" src=\"/default/images/mapper/button-panLeft.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_panReset\" title=\"Pan To Default\"><img class=\"button\" src=\"/default/images/mapper/button-panReset.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_panRight\" title=\"Pan Map Right\"><img class=\"button\" src=\"/default/images/mapper/button-panRight.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                             </tr> ");
            //mapperBuilder.AppendLine("                             <tr> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_layerCustom\" title=\"Block/Lot: Toggle Block/Lot Map Layer\"><img class=\"button\" src=\"/default/images/mapper/button-blockLot.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_layerReset\" title=\"Reset Map Type\"><img class=\"button\" src=\"/default/images/mapper/button-layerReset.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td>&nbsp;</td> ");
            //mapperBuilder.AppendLine("                                 <td></td> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_panDown\" title=\"Pan Map Down\"><img class=\"button\" src=\"/default/images/mapper/button-panDown.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td></td> ");
            //mapperBuilder.AppendLine("                             </tr> ");
            //mapperBuilder.AppendLine("                             <tr><td colspan=\"6\"><br /></td></tr> ");
            //mapperBuilder.AppendLine("                             <tr> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"./mapedit\" id=\"toolbox_reset\" title=\"Reset: Reset Map To Defaults\"><img class=\"button\" src=\"/default/images/mapper/button-reset.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_toggleControls\" title=\"Controls: Toggle Map Controls\"><img class=\"button\" src=\"/default/images/mapper/button-controls.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td>&nbsp;</td> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_zoomIn\" title=\"Zoom Map In\" onclick=\"checkZoomLevel();\"><img class=\"button\" src=\"/default/images/mapper/button-zoomIn.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_zoomReset\" title=\"Reset Zoom Levels\"><img class=\"button\" src=\"/default/images/mapper/button-zoomReset2.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                                 <td><a href=\"#\" id=\"toolbox_zoomOut\" title=\"Zoom Map Out\" onclick=\"checkZoomLevel();\"><img class=\"button\" src=\"/default/images/mapper/button-zoomOut.png\" /></a></td> ");
            //mapperBuilder.AppendLine("                             </tr> ");
            ...
            //mapperBuilder.AppendLine("                     <div class=\"tab\" > ");
            //mapperBuilder.AppendLine("                         <div class=\"tab-content\"> ");
            //mapperBuilder.AppendLine("                             <a href=\"#\" id=\"toolbox_manageItem\" title=\"Manage Location Details\" onclick=\"action1();\"><img class=\"button\" src=\"/default/images/mapper/button-action1.png\" /></a>&nbsp ");
            //mapperBuilder.AppendLine("                             <a href=\"#\" id=\"toolbox_manageOverlay\" title=\"Manage Map Coverage\" onclick=\"action2();\"><img class=\"button\" src=\"/default/images/mapper/button-action2.png\" /></a>&nbsp ");
            //mapperBuilder.AppendLine("                             <a href=\"#\" id=\"toolbox_managePOI\" title=\"Manage Point of Interest\" onclick=\"action3();\"><img class=\"button\" src=\"/default/images/mapper/button-action3.png\" /></a> ");
            //mapperBuilder.AppendLine("                             <br/> ");
            //mapperBuilder.AppendLine("                             <br/> ");
            ...
            //mapperBuilder.AppendLine(" 						<div class=\"tab-content\"> ");
            //mapperBuilder.AppendLine(" 							<a href=\"#\" id=\"toolbox_placeItem\" title=\"Place a Point\"><img src=\"/default/images/mapper/button-action1.png\" /></a> ");
            //mapperBuilder.AppendLine(" 							<a href=\"#\" id=\"item_getUserLocation\" title=\"Center On Your Current Position\"><img src=\"/default/images/mapper/getUserLocation.png\" /></a> ");
            //mapperBuilder.AppendLine(" 							<div style=\"clear:both;text-align:left;\"> ");
            //mapperBuilder.AppendLine(" 								<br /> ");
            ...
            //mapperBuilder.AppendLine("                     <div class=\"tab\" style=\"text-align:center;\"> ");
            //mapperBuilder.AppendLine("                         <div class=\"tab-content\"> ");
            //mapperBuilder.AppendLine("                             <a href=\"#\" id=\"toolbox_placeOverlay\" title=\"Toggle Overlay Editting\"><img src=\"/default/images/mapper/button-action2.png\" /></a> ");
            //mapperBuilder.AppendLine("                             <a href=\"#\" id=\"overlay_getUserLocation\" title=\"Center On Your Current Position\"><img src=\"/default/images/mapper/getUserLocation.png\" /></a> ");
            //mapperBuilder.AppendLine("                             <div style=\"clear:both;\"> ");
            //mapperBuilder.AppendLine("                                 <br /><br /> ");
            //mapperBuilder.AppendLine("                             </div> ");
            //mapperBuilder.AppendLine("                             <div id=\"rotation\" style=\"float:left;\"> ");
            ...
            //mapperBuilder.AppendLine("                                     <input class=\"knob\" data-displayInput=\"false\" data-width=\"68\" data-step=\"1\" data-min=\"0\" data-max=\"360\" data-cursor=true data-bgColor=\"#B2B2B2\" data-fgColor=\"#111111\" data-thickness=\"0.3\" value=\"0\"> ");
            //mapperBuilder.AppendLine("                                 </div> ");
            //mapperBuilder.AppendLine("                                 <a id=\"rotationCounterClockwise\" href=\"#\" title=\".1&deg Left: Click to Rotate .1&deg Counter-Clockwise\" onclick=\"rotate(-0.1)\"><img src=\"/default/images/mapper/rotation-counterClockwise.png\" /></a> ");
            //mapperBuilder.AppendLine("                                 <a id=\"rotationReset\" href=\"#\" title=\"Reset: Click to Reset Rotation\" onclick=\"rotate(0)\"><img src=\"/default/images/mapper/rotation-reset.png\" /></a> ");
            //mapperBuilder.AppendLine("                                 <a id=\"rotationClockwise\" href=\"#\" title=\".1&deg Right: Click to Rotate .1&deg Clockwise\" onclick=\"rotate(0.1)\"><img src=\"/default/images/mapper/rotation-clockwise.png\" /></a> ");
            //mapperBuilder.AppendLine("                             </div> ");
            ...
            //mapperBuilder.AppendLine("                             <a href=\"#\" id=\"toolbox_placePOI\" title=\"Place Point Of Interest\"><img src=\"/default/images/mapper/button-action3.png\" /></a> ");
            //mapperBuilder.AppendLine("                             <a href=\"#\" id=\"poi_getUserLocation\" title=\"Center On Your Current Position\"><img src=\"/default/images/mapper/getUserLocation.png\" /></a> ");
            //mapperBuilder.AppendLine("                             <br/> ");
            //mapperBuilder.AppendLine("                             <br/> ");
            //mapperBuilder.AppendLine("                                 <a id=\"toolbox_poiMarker\" href=\"#\" title=\"Marker: Place a Point\"><img src=\"/default/images/mapper/button-drawMarker.png\"/></a>  ");
            //mapperBuilder.AppendLine("                                 <a id=\"toolbox_poiCircle\" href=\"#\" title=\"Circle: Place a Circle\"><img src=\"/default/images/mapper/button-drawCircle.png\"/></a>  ");
            //mapperBuilder.AppendLine("                                 <a id=\"toolbox_poiRectangle\" href=\"#\" title=\"Rectangle: Place a Rectangle\"><img src=\"/default/images/mapper/button-drawRectangle.png\"/></a>  ");
            //mapperBuilder.AppendLine("                                 <a id=\"toolbox_poiPolygon\" href=\"#\" title=\"Polygon: Place a Polygon\"><img src=\"/default/images/mapper/button-drawPolygon.png\"/></a>  ");
            //mapperBuilder.AppendLine("                                 <a id=\"toolbox_poiLine\" href=\"#\" title=\"Line: Place a Line\"><img src=\"/default/images/mapper/button-drawLine.png\"/></a>  ");
            //mapperBuilder.AppendLine("                             <br/> ");
            //mapperBuilder.AppendLine("                             <div style=\"clear:both;text-align:left;\"> ");
            //mapperBuilder.AppendLine("                                 <br /> ");
            //mapperBuilder.AppendLine("                                  ");
