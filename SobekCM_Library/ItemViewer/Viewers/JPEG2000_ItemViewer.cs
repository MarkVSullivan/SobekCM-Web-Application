    ...
    public class JPEG2000_ItemViewer : abstractItemViewer
	{
        ...
        public override void Write_Main_Viewer_Section(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            if (UI_ApplicationCache_Gateway.Settings.Servers.Image_Server_Root != null)
                Output.WriteLine("   viewer.open(\"" + CurrentMode.Base_URL + "iipimage/iipsrv.fcgi?DeepZoom=" + UI_ApplicationCache_Gateway.Settings.Servers.Image_Server_Root.Replace("\\", "/") + CurrentItem.Web.AssocFilePath.Replace("\\", "/") + FileName + ".dzi\");");
            else
                Output.WriteLine("   viewer.open(\"" + CurrentMode.Base_URL + "iipimage/iipsrv.fcgi?DeepZoom=" + UI_ApplicationCache_Gateway.Settings.Servers.Image_Server_Network.Replace("\\", "/") + CurrentItem.Web.AssocFilePath.Replace("\\", "/") + FileName + ".dzi\");");
