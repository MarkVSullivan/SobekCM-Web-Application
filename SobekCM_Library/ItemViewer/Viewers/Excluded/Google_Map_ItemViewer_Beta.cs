...
namespace SobekCM.Library.ItemViewer.Viewers
{
    ...
    class Google_Map_ItemViewer_Beta : abstractItemViewer_OLD
    {
        ...
        /// <summary> Constructor for a new instance of the Map_ItemViewer_Beta class </summary>
        public Google_Map_ItemViewer_Beta()
        {
        ...
        /// <param name="Tracer"> Trace object keeps a list of each method executed and important milestones in rendering </param>
        public void Add_Map_Scripts(TextWriter Output, Custom_Tracer Tracer )
        {
            if (CurrentMode.ViewerCode == "mapsearch")
                googleItemSearch = true;

            Tracer.Add_Trace("map_itemviewer_beta.Write_HTML", "Adding google map instructions as script");
        ...
        public override void Write_Main_Viewer_Section(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            if (Tracer != null)
            {
                Tracer.Add_Trace("Map_ItemViewer.Write_Main_Viewer_Section", "");
            }

            Output.WriteLine("        <!-- MAP VIEWER OUTPUT -->" + Environment.NewLine);
            ...
            //Output.WriteLine("          </td>");
            Output.WriteLine("        <!-- END MAP VIEWER OUTPUT -->  itemviewer pplacholder");
        }
