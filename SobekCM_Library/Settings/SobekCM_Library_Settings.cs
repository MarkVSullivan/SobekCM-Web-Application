...
namespace SobekCM.Library.Settings
{
	...
	public class SobekCM_Library_Settings
	{
		...
		{
			get { return new ReadOnlyCollection<Metadata_Search_Field>(metadataFields); }
		}
		...
		{
			get { return privacyEmailAddress; }
		}
		...
		{
			get { return includePartnersOnSystemHome; }
		}
		...
		{
			get { return includeTreeviewOnSystemHome; }
		}
		...
		{
			get { return prearchiveFilesToDelete; }
		}
		...
		{
			get { return postarchiveFilesToDelete; }
		}
		...
		{
			get { return buildMarcFeedByDefault; }
		}
		...
		public static string System_Error_URL { get; set; }
		...
		{
			get { return (inProcessSubmissionLocation.Length > 0) ? inProcessSubmissionLocation : baseDirectory + "\\mySobek\\InProcess"; }
		}
		...
		public static List<string> Reserved_Keywords
		{
			get
			{
				List<string> returnValue = new List<string> {"l", "my", "fragment", "json", 
