...
namespace SobekCM.Library.MySobekViewer
{
    ...
    /// </ul></remarks>
    public class Users_Admin_MySobekViewer : abstract_MySobekViewer
    {
        ...
        {
            Tracer.Add_Trace("Users_Admin_MySobekViewer.Write_HTML", "Do nothing");
        }
        ...
        {
            Tracer.Add_Trace("Users_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Add hidden field");
            ...
            Tracer.Add_Trace("Users_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Add the rest of the form");
        ...
        /// <summary> Constructor for a new instance of the Users_Admin_MySobekViewer class </summary>
        ...
        public Users_Admin_MySobekViewer(User_Object User, SobekCM_Navigation_Object currentMode, Aggregation_Code_Manager Code_Manager, Custom_Tracer Tracer)
            : base(User)
        {
            Tracer.Add_Trace("Users_Admin_MySobekViewer.Constructor", String.Empty);
