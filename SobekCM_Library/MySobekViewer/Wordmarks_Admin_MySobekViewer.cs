...
namespace SobekCM.Library.MySobekViewer
{
    ...
    /// </ul></remarks>
    public class Wordmarks_Admin_MySobekViewer : abstract_MySobekViewer
    {
        private readonly string actionMessage;

        #region Constructor

        /// <summary> Constructor for a new instance of the Wordmarks_Admin_MySobekViewer class </summary>
        ...
        public Wordmarks_Admin_MySobekViewer(User_Object User, SobekCM_Navigation_Object Current_Mode, Custom_Tracer Tracer)
            : base(User)
        {
            Tracer.Add_Trace("Wordmarks_Admin_MySobekViewer.Constructor", String.Empty);
            ...
            if (currentMode.isPostBack)
            {
                try
                {
                    ...
                    {
                        Tracer.Add_Trace("Wordmarks_Admin_MySobekViewer.Constructor", "Delete wordmark '" + delete_value + "'");
                    ...
                    else
                    {
                        ...
                        {
                            Tracer.Add_Trace("Wordmarks_Admin_MySobekViewer.Constructor", "Save wordmark '" + save_value + "'");
        ...
        {
            Tracer.Add_Trace("Wordmarks_Admin_MySobekViewer.Write_HTML", "Do nothing");
        }
        ...
        {
            Tracer.Add_Trace("Wordmarks_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Add any popup divisions for form elements");
            ...
            Tracer.Add_Trace("Wordmarks_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Write the HTML for the rest of the form");

            Output.WriteLine("<!-- Wordmarks_Admin_MySobekViewer.Add_HTML_In_Main_Form -->");
