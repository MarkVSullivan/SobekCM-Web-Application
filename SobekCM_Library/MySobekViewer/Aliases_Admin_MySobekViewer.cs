...
namespace SobekCM.Library.MySobekViewer
{
    ...
    /// </ul></remarks>
    public class Aliases_Admin_MySobekViewer : abstract_MySobekViewer
    {
        ...
        /// <summary> Constructor for a new instance of the Aliases_Admin_MySobekViewer class </summary>
        ...
        public Aliases_Admin_MySobekViewer(User_Object User, SobekCM_Navigation_Object currentMode, Dictionary<string,string> Aggregation_Aliases, Custom_Tracer Tracer)
            : base(User)
        {
            Tracer.Add_Trace("Aliases_Admin_MySobekViewer.Constructor", String.Empty);
                    ...
                    if (save_value.Length > 0)
                    {
                        ...
                        if (save_value[0] == '-')
                        {
                            if ( save_value.Length > 1 )
                            {
                                ...
                                Tracer.Add_Trace("Aliases_Admin_MySobekViewer.Constructor", "Delete alias '" + save_value + "'");
                        ...
                        {
                            Tracer.Add_Trace("Aliases_Admin_MySobekViewer.Constructor", "Save alias '" + save_value + "'");
        ...
        {
            Tracer.Add_Trace("Aliases_Admin_MySobekViewer.Write_HTML", "Do nothing");
        }
        ...
        {
            Tracer.Add_Trace("Aliases_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Add any popup divisions for form elements");
            ...
            Tracer.Add_Trace("Aliases_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Write the rest of the form ");

            Output.WriteLine("<!-- Aliases_Admin_MySobekViewer.Add_HTML_In_Main_Form -->");
