...
namespace SobekCM.Library.MySobekViewer
{
    ...
    /// </ul></remarks>
    public class Thematic_Headings_Admin_MySobekViewer : abstract_MySobekViewer
    {
        ...
        public Thematic_Headings_Admin_MySobekViewer(User_Object User,
            SobekCM_Navigation_Object Current_Mode,
            List<Thematic_Heading> Thematic_Headings,
            Custom_Tracer Tracer)
            : base(User)
        {
            Tracer.Add_Trace("Thematic_Headings_Admin_MySobekViewer.Constructor", String.Empty);
        ...
        {
            Tracer.Add_Trace("Thematic_Headings_Admin_MySobekViewer.Write_HTML", "Do nothing");
        }
        ...
        {
            Tracer.Add_Trace("Thematic_Headings_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Add any popup divisions for form elements");
            ...
            Tracer.Add_Trace("Thematic_Headings_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Write the rest of the form ");

            Output.WriteLine("<!-- Thematic_Headings_Admin_MySobekViewer.Add_HTML_In_Main_Form -->");
