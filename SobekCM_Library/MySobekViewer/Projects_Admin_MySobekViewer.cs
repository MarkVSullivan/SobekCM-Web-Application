...
namespace SobekCM.Library.MySobekViewer
{
    ...
    /// </ul></remarks>
    public class Projects_Admin_MySobekViewer : abstract_MySobekViewer
    {
        private readonly string actionMessage;

        #region Constructor

        /// <summary> Constructor for a new instance of the Projects_Admin_MySobekViewer class </summary>
        ...
        public Projects_Admin_MySobekViewer(User_Object User, SobekCM_Navigation_Object currentMode, Custom_Tracer Tracer)
            : base(User)
        {
            Tracer.Add_Trace("Projects_Admin_MySobekViewer.Constructor", String.Empty);
            ...
            if (currentMode.isPostBack)
            {
                try
                {
                    ...
                    {
                        Tracer.Add_Trace("Projects_Admin_MySobekViewer.Constructor", "Save project '" + save_value + "'");
        ...
        {
            Tracer.Add_Trace("Projects_Admin_MySobekViewer.Write_HTML", "Do nothing");
        ...
        {
            Tracer.Add_Trace("Projects_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Add any popup divisions for form elements");
            ...
            Tracer.Add_Trace("Projects_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Write the rest of the form html");

            // Get the list of all projects
            DataSet projectsSet = SobekCM_Database.Get_All_Projects_Templates(Tracer);

            Output.WriteLine("<!-- Projects_Admin_MySobekViewer.Add_HTML_In_Main_Form -->");
