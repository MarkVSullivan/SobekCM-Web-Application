...
namespace SobekCM.Library.MySobekViewer
{
    ...
    /// </ul></remarks>
    class Settings_Admin_MySobekViewer : abstract_MySobekViewer
    {
        ...
        /// <summary> Constructor for a new instance of the Thematic_Headings_Admin_MySobekViewer class </summary>
        ...
        public Settings_Admin_MySobekViewer(User_Object User, SobekCM_Navigation_Object Current_Mode, Custom_Tracer Tracer) : base(User)
        {
            ...
            string[] language_options = Language_Enum_Converter.Language_Name_Array;
            ...
            Add_Config_Setting("Database Instance", ConfigurationManager.AppSettings["Database_Source"], "Name of the database server, or database server instance, which hosts the SobekCM database.\n\nThis is used to build the connection string and allow most other settings to be retrieved from the database.\n\nExamples: '10.4.40.84\\SobekSandbox', 'lib-ufdc-cache', 'localhost', etc...\n\nThis value resides in the web.config file on the web server.  See your database and web server administrator to change this value.");
            Add_Config_Setting("Database Name", ConfigurationManager.AppSettings["Database_Name"], "Database name for the catalog on the database server indicated.\n\nThis is used to build the connection string and allow most other settings to be retrieved from the database.\n\nExamples: 'SobekCM_Prod', 'UFDC_Prod', etc...\n\nThis value resides in the web.config file on the web server.  See your database and web server administrator to change this value." );
        ...
        /// <value> This returns ADMIN since the top-level navigation should include the administrative sub-options as well </value>
        ...
        {
            Tracer.Add_Trace("Settings_Admin_MySobekViewer.Write_HTML", "Do nothing");
        }
        ...
        {
            Tracer.Add_Trace("Settings_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Write the rest of the form ");
            ...
            Output.WriteLine("<!-- Settings_Admin_MySobekViewer.Add_HTML_In_Main_Form -->");
