...
namespace SobekCM.Library.MySobekViewer
{
    ...
    /// </ul></remarks>
    public class Aggregations_Mgmt_Admin_MySobekViewer : abstract_MySobekViewer
    {
        ...
        /// <summary> Constructor for a new instance of the Aggregations_Mgmt_Admin_MySobekViewer class </summary>
        ...
        public Aggregations_Mgmt_Admin_MySobekViewer(User_Object User, SobekCM_Navigation_Object currentMode, Aggregation_Code_Manager Code_Manager, Custom_Tracer Tracer)
            : base(User)
        {
            Tracer.Add_Trace("Aggregations_Mgmt_Admin_MySobekViewer.Constructor", String.Empty);
                                    ...
                                    try
                                    {
                                        ...
                                        if (!Directory.Exists(folder))
                                        {
                                            ...
                                            if (File.Exists(SobekCM_Library_Settings.Base_Directory + "default/images/default_button.gif"))
                                                File.Copy(SobekCM_Library_Settings.Base_Directory + "default/images/default_button.png", folder + "/images/buttons/coll.gif");
        ...
        {
            Tracer.Add_Trace("Aggregations_Mgmt_Admin_MySobekViewer.Write_HTML", "Do nothing");
        }
        ...
        {
            Tracer.Add_Trace("Aggregations_Mgmt_Admin_MySobekViewer.Add_HTML_In_Main_Form", "");
            ...
            Output.WriteLine();
               ...
               Output.WriteLine("<!-- Aggregations_Mgmt_Admin_MySobekViewer.Add_HTML_In_Main_Form -->");
