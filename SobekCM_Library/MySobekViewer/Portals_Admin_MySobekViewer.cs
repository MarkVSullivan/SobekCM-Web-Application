...
namespace SobekCM.Library.MySobekViewer
{
    ...
    /// </ul></remarks>
    public class Portals_Admin_MySobekViewer : abstract_MySobekViewer
    {
        private readonly string actionMessage;
        private readonly Portal_List portals;

        /// <summary> Constructor for a new instance of the Portals_Admin_MySobekViewer class </summary>
        /// <param name="User"> Authenticated user information </param>
        /// <param name="Current_Mode"> Mode / navigation information for the current request</param>
        /// <param name="URL_Portals"> List of all web portals into this system </param>
        /// <param name="Tracer">Trace object keeps a list of each method executed and important milestones in rendering</param>
        public Portals_Admin_MySobekViewer(User_Object User, SobekCM_Navigation_Object Current_Mode, Portal_List URL_Portals, Custom_Tracer Tracer)
            : base(User)
        {
            Tracer.Add_Trace("Portals_Admin_MySobekViewer.Constructor", String.Empty);
        ...
        {
            Tracer.Add_Trace("Portals_Admin_MySobekViewer.Write_HTML", "Do nothing");
        }
        ...
        public override void Add_HTML_In_Main_Form(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            Tracer.Add_Trace("Portals_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Adds the portal information to the main form");
            ...
            Output.WriteLine("<!-- Portals_Admin_MySobekViewer.Add_HTML_In_Main_Form -->");
