...
namespace SobekCM.Library.MySobekViewer
{
    ...
    /// </ul></remarks>
    public class IP_Restrictions_Admin_MySobekViewer : abstract_MySobekViewer
    {
        ...
        public IP_Restrictions_Admin_MySobekViewer( User_Object User, SobekCM_Navigation_Object currentMode, IP_Restriction_Ranges IP_Restrictions, Custom_Tracer Tracer ) : base(User)
        {
            Tracer.Add_Trace("IP_Restrictions_Admin_MySobekViewer.Constructor", String.Empty);
        ...
        {
            Tracer.Add_Trace("IP_Restrictions_Admin_MySobekViewer.Write_HTML", "Do nothing");
        }
        ...
        public override void Add_HTML_In_Main_Form(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            {
                Tracer.Add_Trace("IP_Restrictions_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Display details regarding one IP restrictive range");
            ...
            Tracer.Add_Trace("IP_Restrictions_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Display main IP restrictive range admin form");
            Output.WriteLine("<div class=\"SobekHomeText\">");
            Output.WriteLine("  <blockquote>");
