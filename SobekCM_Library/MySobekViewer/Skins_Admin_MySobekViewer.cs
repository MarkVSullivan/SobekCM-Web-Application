...
namespace SobekCM.Library.MySobekViewer
{
    ...
    /// </ul></remarks>
    public class Skins_Admin_MySobekViewer : abstract_MySobekViewer
    {
        ...
        /// <summary> Constructor for a new instance of the Skins_Admin_MySobekViewer class </summary>
        ...
        public Skins_Admin_MySobekViewer(User_Object User, SobekCM_Navigation_Object currentMode, SobekCM_Skin_Collection Web_Skin_Collection, Custom_Tracer Tracer)
            : base(User)
        {
            Tracer.Add_Trace("Skins_Admin_MySobekViewer.Constructor", String.Empty);
            ...
            if (currentMode.isPostBack)
            {
                try
                {
                    ...
                    {
                        Tracer.Add_Trace("Skins_Admin_MySobekViewer.Constructor", "Reset html skin '" + reset_value + "'");
                    ...
                    else
                    {
                        ...
                        {
                            Tracer.Add_Trace("Skins_Admin_MySobekViewer.Constructor", "Save html skin '" + save_value + "'");
        ...
        {
            Tracer.Add_Trace("Skins_Admin_MySobekViewer.Write_HTML", "Do nothing");
        }
        ...
        {
            Tracer.Add_Trace("Skins_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Add any popup divisions for form elements");
            ...
            Tracer.Add_Trace("Skins_Admin_MySobekViewer.Add_HTML_In_Main_Form", "");

            Output.WriteLine("<!-- Skins_Admin_MySobekViewer.Add_HTML_In_Main_Form -->");
