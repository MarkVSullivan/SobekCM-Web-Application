...
namespace SobekCM.Library.MySobekViewer
{
    public class Edit_TEI_Item_MySobekViewer: abstract_MySobekViewer
    {
        ...
        public Edit_TEI_Item_MySobekViewer(RequestCache RequestSpecificValues) : base(RequestSpecificValues)
        {
            ...
            RequestSpecificValues.Tracer.Add_Trace("Edit_TEI_Item_MySobekViewer.Constructor", "Validate provided bibid / vid");
            ...
            {
                RequestSpecificValues.Tracer.Add_Trace("Edit_TEI_Item_MySobekViewer.Constructor", "BibID or VID was not provided!");
            ...
            RequestSpecificValues.Tracer.Add_Trace("Edit_TEI_Item_MySobekViewer.Constructor", "Validate bibid/vid exists");
            ...
            {
                RequestSpecificValues.Tracer.Add_Trace("Edit_TEI_Item_MySobekViewer.Constructor", "BibID/VID indicated is not valid", Custom_Trace_Type_Enum.Error);
                RequestSpecificValues.Current_Mode.Mode = Display_Mode_Enum.Error;
                RequestSpecificValues.Current_Mode.Error_Message = "Invalid Request : BibID/VID indicated is not valid";
                return;
            }

            RequestSpecificValues.Tracer.Add_Trace("Edit_TEI_Item_MySobekViewer.Constructor", "Try to pull this sobek complete item");
            ...
            if (currentItem == null)
            {
                RequestSpecificValues.Tracer.Add_Trace("Edit_TEI_Item_MySobekViewer.Constructor", "Unable to build complete item");
                RequestSpecificValues.Current_Mode.Mode = Display_Mode_Enum.Error;
        ...
        {
            Tracer.Add_Trace("Edit_TEI_Item_MySobekViewer.Write_HTML", "Add instructions");
