...
namespace SobekCM.Library.MySobekViewer
{
    ...
    /// </ul></remarks>
    public class User_Group_Admin_MySobekViewer : abstract_MySobekViewer
    {
        ...
        /// <summary> Constructor for a new instance of the User_Group_Admin_MySobekViewer class </summary>
        ...
        public User_Group_Admin_MySobekViewer(User_Object User, SobekCM_Navigation_Object currentMode, Aggregation_Code_Manager Code_Manager, Custom_Tracer Tracer)
            : base(User)
        {
            Tracer.Add_Trace("User_Group_Admin_MySobekViewer.Constructor", String.Empty);
        ...
        {
            Tracer.Add_Trace("User_Group_Admin_MySobekViewer.Write_HTML", "Do nothing");
        }
        ...
        {
            Tracer.Add_Trace("User_Group_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Add hidden field");
            ...
            Tracer.Add_Trace("User_Group_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Add the rest of the form");

            Output.WriteLine("<!-- User_Group_Admin_MySobekViewer.Add_HTML_In_Main_Form -->");
