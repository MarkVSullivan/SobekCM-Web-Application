...
namespace SobekCM.Library.MySobekViewer
{
    ...
    /// </ul></remarks>
    public class Builder_Admin_MySobekViewer : abstract_MySobekViewer
    {
        /// <summary> Constructor for a new instance of the Builder_Admin_MySobekViewer class </summary>
        /// <param name="User"> Authenticated user information </param>
        /// <param name="Current_Mode"> Mode / navigation information for the current request</param>
        public Builder_Admin_MySobekViewer(User_Object User, SobekCM_Navigation_Object Current_Mode)
            : base(User)
        {
        ...
        {
            Tracer.Add_Trace("Builder_Admin_MySobekViewer.Write_HTML", "Do nothing");
        }
        ...
        {
            Tracer.Add_Trace("Builder_Admin_MySobekViewer.Add_HTML_In_Main_Form", "Add the current status and add html controls to change status");

            Output.WriteLine("<!-- Builder_Admin_MySobekViewer.Add_HTML_In_Main_Form -->");
