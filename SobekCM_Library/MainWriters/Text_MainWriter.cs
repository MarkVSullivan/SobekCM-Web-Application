...
namespace SobekCM.Library.MainWriters
{
    ...
    public class Text_MainWriter : abstractMainWriter
    {
        ...
        public Text_MainWriter(RequestCache RequestSpecificValues) : base(RequestSpecificValues)
        {
            // All work done in base class
        }

        /// <summary> Gets the enumeration of the type of main writer </summary>
        /// <value> This property always returns the enumerational value <see cref="Writer_Type_Enum.Text"/>. </value>
        ...
        public override void Write_Html(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            Output.WriteLine("  <title>" + RequestSpecificValues.Current_Mode.SobekCM_Instance_Abbreviation + " - Text Writer</title>");
            Output.WriteLine();
            Output.WriteLine("  <!-- " + RequestSpecificValues.Current_Mode.SobekCM_Instance_Name + " -->");
        ...
        protected internal void display_group(TextWriter Output)
        {
            ...
            DataSet thisItem = Engine_Database.Get_Item_Group_Details(RequestSpecificValues.Current_Mode.BibID, null);
            ...
            // Add the links first
            Output.Write("<a href=\"?b=" + RequestSpecificValues.Current_Mode.BibID + "\" target=\"_BLANK\" >View Group</a>" + Environment.NewLine );
            Output.Write("<br /><br />" + Environment.NewLine );
        ...
        {
            //// Go back to the database and get the datatable
            //Database.Item_Information thisItem = Database.SobekCM_Database.Get_Full_By_ItemID(RequestSpecificValues.Current_Mode.ItemID, RequestSpecificValues.Current_Mode.Collection);
            ...
            //// Add the links first
            //Output.Write("<a href=\"?i=" + RequestSpecificValues.Current_Mode.ItemID + "\" target=\"_BLANK\" >View Item</a>" + Environment.NewLine );
            //Output.Write("<br /><br />" + Environment.NewLine );
