...
namespace SobekCM.Library.MainWriters
{
    ...
    public class Text_MainWriter : abstractMainWriter
    {
        ...
        public override void Write_Html(TextWriter Output, Custom_Tracer Tracer)
        {
            ...
            Output.WriteLine("  <title>" + RequestSpecificValues.Current_Mode.Instance_Abbreviation + " - Text Writer</title>");
            Output.WriteLine();
            Output.WriteLine("  <!-- " + RequestSpecificValues.Current_Mode.Instance_Name + " -->");
