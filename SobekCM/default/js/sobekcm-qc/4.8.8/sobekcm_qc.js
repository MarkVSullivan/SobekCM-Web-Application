...
function Set_Default_Images(no_page_image_url_arg, no_thumb_url_arg) {
    no_page_image_url = no_page_image_url_arg;
    no_thumb_url = no_thumb_url_arg;
}
  ...
  //If the 'Before' radio button is selected
    if (rb_Before.checked == true) {
        ...
        if (ddl_Before.selectedIndex == 0) {
            ...
            prevThumbnail.src = no_page_image_url;
      ...
      //          alert(image_folder+'NoThumb.jpg');
                prevThumbnail.src = thumbnailImageDictionary[ddl_Before.options[ddl_Before.selectedIndex - 1].value] ? thumbnailImageDictionary[ddl_Before.options[ddl_Before.selectedIndex - 1].value] : (no_thumb_url);
        ...
        //set the nextThumbnail
            if (ddl_Before.options[ddl_Before.selectedIndex].value.length>0 ) {
                nextThumbnail.src = thumbnailImageDictionary[ddl_Before.options[ddl_Before.selectedIndex].value] ? thumbnailImageDictionary[ddl_Before.options[ddl_Before.selectedIndex].value] : (no_thumb_url);
                document.getElementById('nextFileName').innerHTML = filename_truncate(ddl_Before.options[ddl_Before.selectedIndex].value);
            } else {
                nextThumbnail.src = no_thumb_url;
        ...
        if (ddl_After.selectedIndex == ddl_After.options.length-1) {
            ...
            nextThumbnail.src = no_page_image_url;
            document.getElementById('nextFileName').innerHTML = '';
        }
            ...
            if (ddl_After.options[ddl_After.selectedIndex + 1].value.length > 0 && thumbnailImageDictionary[ddl_After.options[ddl_After.selectedIndex + 1].value] && thumbnailImageDictionary[ddl_After.options[ddl_After.selectedIndex + 1].value].length > 0) {
                nextThumbnail.src = thumbnailImageDictionary[ddl_After.options[ddl_After.selectedIndex + 1].value] ? thumbnailImageDictionary[ddl_After.options[ddl_After.selectedIndex + 1].value] : (no_thumb_url);
        ...
        if (ddl_After.options[ddl_After.selectedIndex].value.length > 0 && thumbnailImageDictionary[ddl_After.options[ddl_After.selectedIndex].value].length > 0) {
            prevThumbnail.src = thumbnailImageDictionary[ddl_After.options[ddl_After.selectedIndex].value] ? (thumbnailImageDictionary[ddl_After.options[ddl_After.selectedIndex].value]) : no_page_image_url;
    ...
    placeholderImage1.src = thumbnailImageDictionary[firstCheckedFileName] ? thumbnailImageDictionary[firstCheckedFileName] : (no_page_image_url);
    placeholderImage2.src = thumbnailImageDictionary[firstCheckedFileName] ? thumbnailImageDictionary[firstCheckedFileName] : (no_page_image_url);
    placeholderImage3.src = thumbnailImageDictionary[firstCheckedFileName] ? thumbnailImageDictionary[firstCheckedFileName] : (no_page_image_url);
