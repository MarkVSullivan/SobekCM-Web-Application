...
$(document).ready(function () {
    ...
    $('[id*=sbkAghsw_CollectionButtonImg]').each(function () {
        var $this = $(this);
        var hovercardTitle = '<div style=\"display:inline; float:left; font-weight:bold;margin-left:70px;margin-top:-10px;\"><a href=' + $this.find('img').attr('href')+'>' + $this.find('img').attr('alt') + '</a></div><br/>';
