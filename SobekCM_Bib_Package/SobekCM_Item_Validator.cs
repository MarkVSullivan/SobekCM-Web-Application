...
namespace SobekCM.Bib_Package
{
    ...
    public class SobekCM_Item_Validator
    {
        ...
        public static bool Validate_SobekCM_Item(SobekCM.Bib_Package.SobekCM_Item thisBib, List<string> Validation_Errors)
        {
            ...
            if (thisBib.Bib_Info.Type.MODS_Type == SobekCM.Bib_Package.Bib_Info.TypeOfResource_MODS_Enum.UNKNOWN )
            ...
            {
                foreach (SobekCM.Bib_Package.Bib_Info.Identifier_Info thisIdentifier in thisBib.Bib_Info.Identifiers)
                {
