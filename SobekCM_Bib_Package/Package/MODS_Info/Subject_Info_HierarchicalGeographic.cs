...
namespace SobekCM.Bib_Package.Bib_Info
{
    ...
    {
        private string continent, country, province, region, state, territory, county, city, citysection, island, area;
        ...
        internal override string To_GSA_DublinCore(string indent)
        {
            ...
            results.Append(base.To_GSA(Spatial_XML, "dc.Subject", indent));
            results.Append(base.To_GSA(Spatial_XML, "dc.Coverage^spatial", indent));
        ...
        internal override string To_GSA_SobekCM(string indent)
        {
            ...
            if (!String.IsNullOrEmpty(country))
                results.Append(base.To_GSA(country, "sobekcm.Coverage^country", indent));
            if (!String.IsNullOrEmpty(state))
                results.Append(base.To_GSA(state, "sobekcm.Coverage^state", indent));
            if (!String.IsNullOrEmpty(county))
                results.Append(base.To_GSA(county, "sobekcm.Coverage^county", indent));
            if (!String.IsNullOrEmpty(city))
                results.Append(base.To_GSA(city, "sobekcm.Coverage^city", indent));
            return results.ToString();
        }
