    ...
    public class Note_Info : XML_Node_Base_Type, IEquatable<Note_Info>
    {
        ...
        internal string To_MODS()
        {
            ...
            else
            {
                if (!String.IsNullOrEmpty(displayLabel))
                {
                    return "<mods:note" + id_string + " type=\"" + this.Note_Type_String + "\" displayLabel=\"" + base.Convert_String_To_XML_Safe(displayLabel) + "\">" + base.Convert_String_To_XML_Safe(note) + "</mods:note>\r\n";
                }
                else
                {
                    return "<mods:note" + id_string + " type=\"" + this.Note_Type_String + "\">" + base.Convert_String_To_XML_Safe(note) + "</mods:note>\r\n";
                }
            }
        }

        internal void Add_MODS( System.IO.TextWriter result)
        {
