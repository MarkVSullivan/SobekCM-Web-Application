...
namespace SobekCM.Bib_Package.Bib_Info
{
    ...
    public abstract class Subject_Info : XML_Node_Base_Type
    {
        ...
        internal abstract string To_GSA_DublinCore(string indent);

        internal abstract string To_GSA_SobekCM(string indent);

        internal abstract void Add_MODS(System.IO.TextWriter results);
