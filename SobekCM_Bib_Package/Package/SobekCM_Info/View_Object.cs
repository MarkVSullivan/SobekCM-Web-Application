...
namespace SobekCM.Bib_Package.SobekCM_Info
{
    ...
    public class View_Object : IEquatable<View_Object>
    {
        ...
        public string[] Viewer_Codes
        {
            get
            {
                return View_Object.Viewer_Code_By_Type( view_type );
            }
        }

        /// <summary> Returns the METS behavior associated with this viewer </summary>
        internal void Add_METS( System.IO.TextWriter behaviorSec, int view_count )
        {
        ...
        {
            if (other.View_Type == this.View_Type)
                return true;
            else
                return false;
        }
