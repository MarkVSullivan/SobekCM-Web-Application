...
namespace SobekCM.Bib_Package.Tracking
{
    ...
    public class Tracking_Info
    {
        ...
        private List<Tracking_Progress> worklogHistory;
        ...
        public Tracking_Info()
        {
            ...
            firstFlagsByte = 0;
            secondFlagsByte = 0;
            worklogHistory = new List<Tracking_Progress>();
        ...
        {
            get { return material_recd_notes ?? String.Empty;; }
        ...
        public List<Tracking_Progress> History
        {
            get { return worklogHistory; }
        }
        ...
        public bool hasHistoryInformation
        {
            get
            {
                if ((worklogHistory == null) || (worklogHistory.Count == 0))
                    return false;
                else
                    return true;
            }
        ...
        public void Set_Tracking_Info(DataSet Tracking_Info)
        {
            ...
            foreach (DataRow thisRow in Tracking_Info.Tables[1].Rows)
            {
                ...
                worklogHistory.Add(addProgress);
            }
