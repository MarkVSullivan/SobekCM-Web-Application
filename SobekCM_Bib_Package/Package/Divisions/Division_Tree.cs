...
namespace SobekCM.Bib_Package.Divisions
{
	...
	public class Division_Tree
	{
        ...
        private string default_page_label;

		/// <summary> Constructor creates a new instance of the Division_Tree class </summary>
        public Division_Tree( string Default_Page_Label )
		{
        ...
        public void Add_File(SobekCM_File_Info New_File, string Label )
        {
            ...
            if (Roots.Count > 0)
            {
                if (!Roots[Roots.Count - 1].Page)
                {
                    ...
                    lastDivision = (Division_TreeNode)Roots[Roots.Count - 1];
        ...
        {
            List<abstract_TreeNode> pages = this.Pages_PreOrder;
