...
namespace SobekCM.Bib_Package.Divisions
{
	...
	public class Division_TreeNode : abstract_TreeNode
	{
		...
		public Division_TreeNode( ) : base ()
		{
			// Set the collection of children
            children = new List<abstract_TreeNode>();
		}

        /// <summary> Gets or sets the label for this division  </summary>
        ...
        public string Display_Label
        {
            get
            {
                if (label.Length > 0)
                {
                    return base.Convert_String_To_XML_Safe(label);
                }
                else
                {
                    return type;
        ...
        public string Display_Short_Label
        {
            get
            {
                if (label.Length > 0)
                {
                    return base.Convert_String_To_XML_Safe( shorten(label));
                }
                else
                {
                    return type;
        ...
        ///// <summary> Gets the shortened label for this division </summary>
        ///// <remarks>This is used for display in SobekCM</remarks>
