...
namespace SobekCM.Bib_Package.OAI
{
    ...
    public class OAI_Repository_Information
    {
        ...
        public string Earliest_Date_Stamp
        {
            get;
            set;
        }
        ...
        public string Repository_Identifier
        {
            get;
            set;
        }
        ...
        public string Sample_Identifier
        {
            get;
            set;
        }
